...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-2">IMS</div>
      </a>
 ...
 <?php
  ...
  <li class="d-flex align-items-center justify-content-center">
    <a class="nav-link">
        <!-- Tambahkan logo perusahaan berbentuk bulat -->
        <img src="img/buku.png" class="img-circle logo-bulat" width="80" alt="Logo Perusahaan"/>
...
<li class="nav-item">
    <a class="nav-link">
        <div class="d-flex align-items-center justify-content-center" class="name">
            <?php echo $data['nama']; ?>
        </div>
		      ...
		      <?php
			   ...
			   $aksi = $_GET['aksi'];
				   ...
				   if ($aksi == "") {
				    ...
				    if ($aksi == "hapuspengguna2") {
					   include "page/pengguna/hapuspengguna2.php";
				   }
			   }
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Inventory Barang 2024</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
