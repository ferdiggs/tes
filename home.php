...
<br>
	 ...
	 <marquee><h2>Selamat Datang di Sistem Pengelolaan Stock Barang Toko Buku Alif</marquee></h2>
		  <br></br>
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                      <i class="fas fa-reply-all fa-2x text-black-300"></i>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                      <i class="fas fa-paper-plane fa-2x text-black-300"></i>
                    </div>
                  </div>
                </div>
              </div>
